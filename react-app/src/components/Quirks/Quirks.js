  ...
  return(
    <div>
      ...
      <ul id="iframe-quirks-wrapper">
        <li id="iframe-quirk"><iframe src="https://www.youtube-nocookie.com/embed/l1EssrLxt7E" title="Introduction to web development" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe></li>
